...
!!! abstract "The design docs are the source of truth"
    The canonical design lives in the [design documents](../sources/design/00-index.md).
    The implementation follows the design; where the code diverges, **the code is
    what changes**. Read [00 — Index](../sources/design/00-index.md) first.
...
| Doc | Covers |
|-----|--------|
| [00 — Index](../sources/design/00-index.md) | Reading order, glossary, requirement traceability, conventions. |
| [01 — Engine requirements](../sources/design/01-engine-requirements.md) | Requirements R1–R8, MVP / design-for / constraint scope, out-of-scope. |
| [02 — Architecture overview](../sources/design/02-architecture-overview.md) | Layers + dependency rule, Lua bridge, runtime spine, `EngineContext`, coordinate spaces, `GameState`. |
| [03 — Generic 2D concepts](../sources/design/03-2d-game-concepts.md) | Main loop, scene contract, resources, spritesheets/sprites, geometry, audio. |
| [04 — Point & click concepts](../sources/design/04-point-and-click-concepts.md) | Rooms, layers/regions, camera, z-order, hotspots, avatars, SCUMM panel, dialog, inventory. |
| [05 — Scripting API](../sources/design/05-scripting-api.md) | The full Lua API surface, game wiring, error handling. |
| [06 — Data formats](../sources/design/06-data-formats.md) | Exhaustive field reference for every YAML / Lua data file. |
| [Implementation plan](../sources/design/implementation-plan.md) | Milestone roadmap (M0–M7) toward the playable MVP. |
...
[02 — Architecture overview](../sources/design/02-architecture-overview.md) for
