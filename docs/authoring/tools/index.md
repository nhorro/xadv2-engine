...
|------|-------------|--------|
| [Transparentizer](transparentizer.md) | Turn a chroma-key / solid background into real alpha transparency and crop to content. | Useful |
...
!!! info "Why these exist"
    ...
    artifacts, and is misaligned. The transparentizer and spritesheet packer turn
